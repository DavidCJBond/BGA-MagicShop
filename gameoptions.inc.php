 ...
 * magicshop implementation : © <Your name here> <Your email address here>
 *
 ...
 * gameoptions.inc.php
 *
 * magicshop game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in magicshop.game.php)
 *
